...
//    NSString *apnsCertName = @"ttouchdev";
    
#ifdef DEBUG//调试状态，打开LOG功能
      NSString *apnsCertName = @"aps_dev";
#else//发布状态，关闭LOG功能
      NSString *apnsCertName = @"aps_distribution";
#endif
  
    
    [[EaseMob sharedInstance] registerSDKWithAppKey:@"ttouch#kuaile" apnsCertName:apnsCertName otherConfig:@{kSDKConfigEnableConsoleLogger:@YES}];
...
//        [[ApplyViewController shareController] addNewApply:dic];
        [[[GroupListViewController alloc] init] addGroupNewApply:dic];
        if (self.mainController) {
            [self.mainController setupUntreatedApplyCount];
        }
    }
...
- (void)didConnectionStateChanged:(EMConnectionState)connectionState
{
    ...
    [ICELoginUserModel sharedInstance].connectionState = connectionState;
