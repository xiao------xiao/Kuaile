...
+(UIButton *)createPictureButtonWithNormalImage:(NSString *)imageName selectImage:(NSString *)selectImageName{
    ...
    if (imageName) {
        ...
        [btnmen setBackgroundImage:[UIImage imageNamed:imageName] forState:UIControlStateNormal];
    }
   
    if (selectImageName) {
        [btnmen setBackgroundImage:[UIImage imageNamed:selectImageName] forState:UIControlStateSelected];
    }
    return btnmen;
