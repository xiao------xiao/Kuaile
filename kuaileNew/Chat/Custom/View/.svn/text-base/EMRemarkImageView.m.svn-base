...
- (void)setRemark:(NSString *)remark
{
    ...
    _nickName = _remarkLabel.text;

    NSString *avatar = [TZEaseMobManager avatarWithUsername:remark];
    [_imageView sd_setImageWithURL:[NSURL URLWithString:avatar] placeholderImage:[UIImage imageNamed:@"chatListCellHead.png"]];

//    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
//        NSString *headURL = [ApiUserAvatar stringByAppendingString:remark];
//        [_imageView sd_setImageWithURL:[NSURL URLWithString:headURL] placeholderImage:nil];
//    });
}
