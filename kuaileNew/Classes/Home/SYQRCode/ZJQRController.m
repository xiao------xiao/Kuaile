...
@interface ZJQRController ()<AVCaptureMetadataOutputObjectsDelegate>{
    int num;
    BOOL upOrdown;
    NSTimer * timer;
...
- (void)setCropRect:(CGRect)cropRect{
    ...
    [cropLayer setFillColor:fillColor.CGColor];
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection
{
    ...
    if ([metadataObjects count] >0)
    {
        ...
        TZJobDetailViewController * vc = [[TZJobDetailViewController alloc]init];
        vc.recruit_id = stringValue;
        vc.pushFromScanVc = YES;
